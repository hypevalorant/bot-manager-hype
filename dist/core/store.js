    ...
    return {
        ...
        productAddons: [
            ...
            },
            {
                ...
                code: "auto-restart",
                name: "AutoRestart",
                description: "O bot já reinicia automaticamente em caso de erro.",
                priceCents: 0,
                currency: "BRL",
            ...
            },
            {
                ...
                description: "O QR Code personalizado já faz parte do pacote, sem custo extra.",
                priceCents: 0,
                currency: "BRL",
                informationalOnly: true,
            },
            {
                ...
                description: "Nossa equipe permanece disponível para ajudar, sem custo extra no momento.",
                priceCents: 0,
                currency: "BRL",
                informationalOnly: true,
            },
